 ...
 *
 */
public abstract class AnvizentRowFlatMapFunction extends BaseDBInsertableAnvizentSymmetricFlatMapFunction<Row, HashMap<String, Object>> {

	private static final long serialVersionUID = 1L;

	public AnvizentRowFlatMapFunction(ConfigBean configBean, MappingConfigBean mappingConfigBean, LinkedHashMap<String, AnvizentDataType> structure,

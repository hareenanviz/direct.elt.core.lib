 ...
 *
 */
public abstract class BaseDBInsertableAnvizentSymmetricFlatMapFunction<R, E> extends BaseDBInsertableAnvizentFlatMapFunction<R, R, E> {

	private static final long serialVersionUID = 1L;

	public BaseDBInsertableAnvizentSymmetricFlatMapFunction(ConfigBean configBean, MappingConfigBean mappingConfigBean, LinkedHashMap<String, AnvizentDataType> structure,

 ...
 *
 */
public abstract class AnvizentPairFunction extends BaseAnvizentSymmetricPairFunction<HashMap<String, Object>, HashMap<String, Object>> {

	private static final long serialVersionUID = 1L;

	public AnvizentPairFunction(ConfigBean configBean, MappingConfigBean mappingConfigBean, LinkedHashMap<String, AnvizentDataType> structure,

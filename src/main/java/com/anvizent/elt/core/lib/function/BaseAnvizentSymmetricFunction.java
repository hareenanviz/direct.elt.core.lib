 ...
 *
 */
public abstract class BaseAnvizentSymmetricFunction<T, E> extends BaseAnvizentFunction<T, T, E> {

	private static final long serialVersionUID = 1L;

	public BaseAnvizentSymmetricFunction(ConfigBean configBean, MappingConfigBean mappingConfigBean, LinkedHashMap<String, AnvizentDataType> structure,

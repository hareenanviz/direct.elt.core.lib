 ...
 *
 */
public abstract class AnvizentPairToNormalRDDFunction<K> extends BaseAnvizentSymmetricPairToNormalRDDFunction<K, HashMap<String, Object>> {

	private static final long serialVersionUID = 1L;

	public AnvizentPairToNormalRDDFunction(ConfigBean configBean, MappingConfigBean mappingConfigBean, LinkedHashMap<String, AnvizentDataType> structure,

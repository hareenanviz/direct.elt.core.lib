 ...
 *
 */
public abstract class BaseAnvizentFilterFunction<T, E> implements Function<T, Boolean> {
	...
	public BaseAnvizentFilterFunction(ConfigBean configBean, MappingConfigBean mappingConfigBean, LinkedHashMap<String, AnvizentDataType> structure,
	...
	@Override
	public Boolean call(T row) throws Exception {
	...
	private void accumulate(StatsCategory accumulatorKey, T inputRow, Boolean outputRow, AnvizentFunctionException exception) {
	...
	public abstract Boolean process(T row) throws ValidationViolationException, RecordProcessingException, DataCorruptedException;

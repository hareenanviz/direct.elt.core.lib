 ...
 *
 */
public abstract class AnvizentRowFunction extends BaseAnvizentSymmetricFunction<Row, HashMap<String, Object>> {

	private static final long serialVersionUID = 1L;

	public AnvizentRowFunction(ConfigBean configBean, MappingConfigBean mappingConfigBean, LinkedHashMap<String, AnvizentDataType> structure,

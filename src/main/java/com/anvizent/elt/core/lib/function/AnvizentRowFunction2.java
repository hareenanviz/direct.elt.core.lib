...
import com.anvizent.elt.core.lib.row.formatter.AnvizentFromRowErrorSetter2;
 ...
 *
 */
public abstract class AnvizentRowFunction2 extends BaseAnvizentSymmetricFunction2<Row, HashMap<String, Object>> {

	private static final long serialVersionUID = 1L;

	public AnvizentRowFunction2(ConfigBean configBean, MappingConfigBean mappingConfigBean, LinkedHashMap<String, AnvizentDataType> structure,
	...
	@Override
	protected BaseAnvizentErrorSetter2<Row, Row, HashMap<String, Object>> getBaseAnvizentErrorRowSetter() throws InvalidArgumentsException {
		return AnvizentFromRowErrorSetter2.getDefaultInstance();
	}
}
